...
capabilities = {
    ...
    "Slalom Build": {
        "description": "Product strategy, design thinking, and full-stack product delivery for digital innovation",
        "practice_area": "Technology",
        "skill_levels": ["Emerging", "Proficient", "Advanced", "Expert"],
        "certifications": ["Product Management Certification", "Certified Scrum Product Owner", "SAFe Product Owner/Product Manager"],
        "industry_verticals": ["Consumer Products", "Financial Services", "Healthcare"],
        "capacity": 40,
        "consultants": ["marcus.thomas@slalom.com", "zoe.chen@slalom.com"]
    }
}
